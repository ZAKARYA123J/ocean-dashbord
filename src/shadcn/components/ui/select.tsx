...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "dark:placeholder:tw-text-slate-40 tw-flex tw-h-8 tw-w-full tw-items-center tw-justify-between tw-rounded-md tw-border tw-border-slate-400 tw-bg-slate-200 tw-px-3 tw-py-2  tw-text-sm placeholder:tw-text-slate-500  focus:tw-outline-none disabled:tw-cursor-not-allowed disabled:tw-opacity-50 dark:tw-border-slate-600  dark:tw-bg-slate-800",
      className,
    )}
    {...props}
  >

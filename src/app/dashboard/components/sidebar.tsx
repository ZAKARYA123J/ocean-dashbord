...
export function DashboardSidebar() {
  ...
  return (
    <aside className="tw-fixed tw-hidden tw-h-full tw-w-52 tw-border-r tw-border-r-slate-300 tw-bg-slate-100 tw-text-lg tw-font-semibold tw-text-slate-500 dark:tw-border-r-slate-600 dark:tw-bg-slate-950 sm:tw-block">

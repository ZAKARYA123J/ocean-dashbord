    ...
    <ResponsiveTimeRange
      ...
      tooltip={(val) => {
        return (
          ...
          <div className="tw-absolute !tw-z-40 tw-block tw-min-w-max -tw-translate-x-full -tw-translate-y-full tw-break-words tw-rounded-md tw-bg-stone-200 tw-p-4 dark:tw-bg-slate-700">
            <span

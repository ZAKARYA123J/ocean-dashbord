...
export default function Integrations() {
  return (
    <div className=" tw-bg-stone-100 dark:tw-bg-slate-900">
      ...
      <div className="tw-grid tw-grid-flow-col lg:tw-grid-cols-3 sm:tw-grid-cols-2 lg:tw-grid-rows-2 sm:tw-grid-rows-3 tw-grid-rows-6 tw-grid-cols-1 tw-gap-4 tw-p-4">
